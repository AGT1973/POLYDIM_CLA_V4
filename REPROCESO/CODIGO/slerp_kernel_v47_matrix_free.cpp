 ...
 * 1. Antipodalidad Exacta: Selección determinista de eje ortogonal e_min_idx sin NaN.
 * 2. Validación std::isfinite en inputs y outputs.
 * 3. Uso de size_t para evitar overflow en dimensiones masivas.
 */
